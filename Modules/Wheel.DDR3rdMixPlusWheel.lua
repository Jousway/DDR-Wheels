...
local function MoveDifficulty(self,offset,Songs)	
	...
	self:GetChild("DiffChart"):settext(DiffChartNames[DiffCount]):diffuse(DiffColors[DDR.DiffTab[Songs[CurSong][CurDiff]:GetDifficulty()]]):strokecolor(DiffColors[DDR.DiffTab[Songs[CurSong][CurDiff]:GetDifficulty()]])
...
return function(Style)
	...
	return Def.ActorFrame{
		...
		Def.Sprite{
			...
			OnCommand=function(self)
				self:xy(SCREEN_CENTER_X+70,SCREEN_CENTER_Y+30):zoom(DDR.Resize(self:GetWidth(),self:GetHeight(),80,80))
			end
		},
